app.component('product-display', {
    ...
    <div class="product-container">
      ...
      <div class="product-info">
        ...
        <a v-bind:href="url">Stance Socks</a><br>
  ...
  data () {
    return {
        product: 'Socks',
        brand: 'Vue Mastery',
        description: 'These are exquisitly crafted socks, woven by hand.',
        selectedVariant: 0,
...
computed: {
    title() {
        return this.brand + ' ' + this.product + ' ' + this.variants.onSale 
    },
    image() {
